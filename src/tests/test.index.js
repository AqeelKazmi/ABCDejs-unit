...
describe('toWei', () => {
  it('should handle edge cases', () => {
    ...
    assert.equal(units.toWei('.3', 'abcde').toString(10), '300000000000000000');
    assert.throws(() => units.toWei('.', 'wei'), Error);
    assert.throws(() => units.toWei('1.243842387924387924897423897423', 'abcde'), Error);
    assert.throws(() => units.toWei('8723.98234.98234', 'abcde'), Error);
  });
  ...
  it('should return the correct value', () => {
    ...
    assert.equal(units.toWei(1, 'abcde').toString(10), '1000000000000000000');
    assert.equal(units.toWei(1, 'kabcde').toString(10), '1000000000000000000000');
    assert.equal(units.toWei(1, 'grand').toString(10), '1000000000000000000000');
    assert.equal(units.toWei(1, 'mabcde').toString(10), '1000000000000000000000000');
    assert.equal(units.toWei(1, 'gabcde').toString(10), '1000000000000000000000000000');
    assert.equal(units.toWei(1, 'tabcde').toString(10), '1000000000000000000000000000000');

    assert.equal(units.toWei(1, 'kwei').toString(10), units.toWei(1, 'femtoabcde').toString(10));
    assert.equal(units.toWei(1, 'szabo').toString(10), units.toWei(1, 'microabcde').toString(10));
    assert.equal(units.toWei(1, 'finney').toString(10), units.toWei(1, 'milliabcde').toString(10));
    assert.equal(units.toWei(1, 'milli').toString(10), units.toWei(1, 'milliabcde').toString(10));
...
describe('fromWei', () => {
  ...
  it('should return the correct value', () => {
    ...
    assert.equal(units.fromWei(1000000000000000000, 'abcde'), '1');
    assert.equal(units.fromWei(1000000000000000000, 'kabcde'), '0.001');
    assert.equal(units.fromWei(1000000000000000000, 'grand'), '0.001');
    assert.equal(units.fromWei(1000000000000000000, 'mabcde'), '0.000001');
    assert.equal(units.fromWei(1000000000000000000, 'gabcde'), '0.000000001');
    assert.equal(units.fromWei(1000000000000000000, 'tabcde'), '0.000000000001');
  });
});
